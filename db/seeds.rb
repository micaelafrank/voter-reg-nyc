...
puts "🌱 Seeding Voters..."
micaela = Voter.create(first: "Kayla", last: "Brecker", address1: "193 7th Avenue", address2: "2L", postalCode: 11215, age: 27, voting_party: "Democrat", party_id: democrat.id,   password: "password", isActive: true)
milan = Voter.create(first: "Milan", last: "Tessler", address1: "193 7th Avenue", address2: "2L",  postalCode: 11215, age: 28, voting_party: "Independent", party_id: independent.id,  password: "password", isActive: false)
joshua = Voter.create(first: "Joshua", last: "Cohen", address1: "102 Norfolk St", address2: "Apt 9",  postalCode: 10002, age: 32, voting_party: "Democrat", party_id: democrat.id,  password: "password", isActive: true)
anabelle = Voter.create(first: "Anabelle", last: "Sutton", address1: "277 Cumberland St", address2: "2R",  postalCode: 11238, age: 18, voting_party: "Democrat", party_id: democrat.id,   password: "password", isActive: true)
india = Voter.create(first: "India", last: "Allouche", address1: "424 East 9th Street", address2: "Apt 519",  postalCode: 10009, age: 29, voting_party: "Green", party_id: green.id,   password: "password", isActive: true)
peter = Voter.create(first: "Peter", last: "Aarons", address1: "378 Flatbush Ave", address2: "9N",  postalCode: 11217, age: 21, voting_party: "Independent", party_id: independent.id,  password: "password", isActive: true)
mark = Voter.create(first: "Mark", last: "Abrams", address1: "253 West 72nd Street", address2: "1001",  postalCode: 10023 , age: 28, voting_party: "Democrat", party_id: democrat.id,  password: "password", isActive: true)
